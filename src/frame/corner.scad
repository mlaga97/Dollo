...
module basic_corner(){
	module added(){
			translate([0,0,15]) cube([unit_length,unit_length,unit_length*2], center=true);
			translate([0,15,0]) cube([unit_length,unit_length*2,unit_length], center=true);
			translate([15,0,0]) cube([unit_length*2,unit_length,unit_length], center=true);
	}
	module taken(){
		cylinder(d=8.5, h=unit_length*5, center=true);
		rotate([0,90,0]) cylinder(d=8.5, h=unit_length*5, center=true);
		rotate([90,0,0]) cylinder(d=8.5, h=unit_length*5, center=true);
